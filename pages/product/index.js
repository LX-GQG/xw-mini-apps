...
Page({
  ...
  onLoad: function (options) {
    if (this.data.productItems[0].productId == options.id) {
      this.setData({
        product: this.data.productItems[0]
      })
    }
    if (this.data.productItems[1].productId == options.id) {
      this.setData({
        product: this.data.productItems[1]
      })
    }
    if (this.data.productItems[2].productId == options.id) {
      this.setData({
        product: this.data.productItems[2]
      })
    }
  },
